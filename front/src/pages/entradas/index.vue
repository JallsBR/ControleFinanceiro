...
const carregarLista = async () => {
  ...
  try {
    ...
    toast.error('Erro', 'Não foi possível carregar as entradas.')
  } finally {
    loading.value = false
  }
}
...
async function executarExclusao() {
  ...
  try {
    ...
    toast.error('Erro', 'Não foi possível excluir a entrada.')
  } finally {
